...
The time series plot was created in R using Plotly and is hosted as a HTML file. The plot shows 2 lines the red line depcits the fires occured per week and the green line depcits the average acres burned that week. There buttons in the top left corner that allow users to view in 6 month or year long increments
